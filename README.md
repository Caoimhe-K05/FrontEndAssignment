...
~ Movie Page ~ This page displays a short list of movies which havr 'barbie' in their title, this is acheived by reading the information in from an external URL. 
~ Shop Page ~ This page works as a small shop, displaying the name, price and image of a number of shoes, by clicking these items they will be added to a array and once the 'checkout' button is clicked an alert will be displayed with the combines price of each of these items. 
